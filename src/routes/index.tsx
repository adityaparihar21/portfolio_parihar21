  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1600px] items-center justify-between px-6 py-4 md:px-12">
        <a
          href="#top"
          className="flex items-center gap-2 w-10 h-10 md:w-12 md:h-12"
    ...
    <div id="creative">
      <section className="relative z-20 bg-[#050505] pt-32 md:pt-44 pb-12 border-t border-[#222]">
        <div className="mx-auto max-w-[1400px] px-6 md:px-[6vw]">
          ...
          >
            <span className="block font-mono text-[12px] tracking-[0.3em] text-[#e8744a] uppercase">
              {eyebrow}
            </span>
            <motion.h2
              variants={fadeUp}
              transition={{ duration: 1, ease: EASE_OUT_EXPO }}
              className="font-serif text-5xl font-medium leading-[1.05] tracking-tight md:text-7xl text-white uppercase"
            >
              {title}
            </motion.h2>
          </motion.div>
  ...
  return (
    <footer
      ...
      className={`relative overflow-hidden border-t border-border px-6 pt-32 md:px-12 md:pt-44 ${
        !isEngineering ? "pb-8 md:pb-12" : "pb-32 md:pb-44"
      }`}
    >
          ...
          className={
            coinState === "preloader"
              ...
              : themeMode === "select"
                ...
                : "fixed left-6 md:left-[48px] top-4 translate-x-0 translate-y-0 w-10 h-10 md:w-12 md:h-12 z-[60] pointer-events-auto cursor-pointer"
          }
        >
          <AP3DMonogram
